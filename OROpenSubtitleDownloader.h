...
- (void)searchForSubtitlesWithIMDB:(NSString *)imdbid andSeaon:(NSString *)season ansEpisode:(NSString *)episode :(void(^) (NSArray *subtitles, NSError *error))searchResult;
